                      ...
                      Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<ProductVariant>(
                            ...
                            isExpanded: true,
                            // 1. Allow variable height for menu items so text can wrap
                            itemHeight: null,
                            ...
                            // 2. Control how the SELECTED item looks (Collapsed view)
                            // We keep it single-line with ellipsis to prevent the "Image 2" overflow issue
                            ...
                            // 3. Define the Menu Items (Expanded view)
                                      ...
                                      Expanded(
                                        child: Text(
                                          variant.title.isEmpty
                                              ? 'Default'
                                              : variant.title,
                                          // Allow text to wrap in the menu so user can read it all
                                          softWrap: true,
                                          maxLines: 3,
